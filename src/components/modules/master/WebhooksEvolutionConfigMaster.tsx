...
export function WebhooksEvolutionConfigMaster({ preSelectedWorkspaceId }: WebhooksEvolutionConfigMasterProps = {}) {
  ...
  const {
    ...
    refreshConfig
  } = useWorkspaceWebhooks(selectedWorkspaceId || undefined);
  ...
  }, [webhookConfig, selectedWorkspaceId, isLoading]);
  ...
  if (isLoading && !webhookConfig && selectedWorkspaceId) {
    return (
      <div className="p-6">
      ...
      {!selectedWorkspaceId ? (
        ...
        <Tabs defaultValue="config" className="w-full">
          ...
          <TabsContent value="config" className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>Padrão do Workspace: {selectedWorkspace?.name}</CardTitle>
              </CardHeader>
        ...
        <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
          ...
          {selectedLog && (
            <div className="space-y-4">
              <div>
                <h3 className="font-medium mb-2">Informações do Log</h3>
                <div className="grid grid-cols-2 gap-2 text-sm">
                  ...
                  <div>
                    <span className="text-muted-foreground">Evento:</span> {selectedLog.event_type}
                  </div>
                  <div>
